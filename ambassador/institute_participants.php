<?php 
  ...
  if(isset($_GET['confirm']) && !empty($_GET['confirm']) && is_numeric($_GET['confirm'])){
    ...
    $part = getUnconfirmedInsPartById(normal($_GET['confirm']), $ambassador['institute_ID']);
...
?>
<?php 
    $participants = getUnconfirmedInstituteParticipants($ambassador['institute_ID']);
    include 'views/institute_participants.php'; 
?>
