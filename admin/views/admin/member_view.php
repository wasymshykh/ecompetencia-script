                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2 text-right">
                                <a href="member_applicants.php" class="btn btn-dark btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp; Back</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th style="border-left:1px solid #e0e0e0;">Semester</th>
                                            <td><?=$applicant['semester']?></td>
                                        </tr>
                                        <tr>
                                            <th>Reg No</th>
                                            <td colspan="3"><?=$applicant['regno']?></td>
                                        </tr>
                                        <tr>
                                            <th>Experience</th>
                                            <td colspan="3">
                                                <?php if($applicant['experience'] == "Yes"): ?>
                                                    <?=$applicant['experienceyes']?>
                                                <?php else: ?>
                                                    <i>No</i>
                                                <?php endif; ?>
                                            </td>
