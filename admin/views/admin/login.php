...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="<?=ADMIN_URL?>/assets/img/favicon.ico">
  ...
  <body>
      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><strong class="text-primary">Ecompetencia</strong> <span>Admin</span></div>
            <form method="POST" class="text-left form-validate" action="">
              ...
              <div class="form-group-material">
                ...
                <label for="login-username" class="label-material">User id</label>
              </div>
              <div class="form-group-material">
    ...
    <script src="<?=ADMIN_URL?>/assets/js/grasp_mobile_progress_circle-1.0.0.min.js"></script>
    <script src="<?=ADMIN_URL?>/assets/vendor/jquery.cookie/jquery.cookie.js"> </script>
